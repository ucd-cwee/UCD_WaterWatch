...
void ExcelCell::merged(bool merged) {
    using namespace xlnt;
    xlnt::cell& ThisCell = To_Cell(*this);
    return ThisCell.merged();
};
cweeStr ExcelCell::error() const {
    using namespace xlnt;
    xlnt::cell& ThisCell = To_Cell(*this);
    return ThisCell.error();
};
...
cweeSharedPtr<ExcelCell> ExcelCell::offset(int column, int row) {
    using namespace xlnt;
    xlnt::cell& ThisCell = To_Cell(*this);
    return ThisCell.offset();
};
cweeSharedPtr<ExcelWorksheet> ExcelCell::worksheet() {
    using namespace xlnt;
    xlnt::cell& ThisCell = To_Cell(*this);
    return To_Worksheet(ThisCell.worksheet());
};
...
cweeSharedPtr<ExcelWorkbook> ExcelCell::workbook() {
    using namespace xlnt;
    xlnt::cell& ThisCell = To_Cell(*this);
    return To_Workbook(ThisCell.workbook()); // NOT COPY
};
...
template <> cweeTime ExcelCell::value<cweeTime>() const {
    using namespace xlnt;
    xlnt::cell& ThisCell = To_Cell(*this);
    AUTO dt = ThisCell.value<datetime>();
    return cweeTime(dt.to_iso_string());
};
...
cweeSharedPtr<ExcelRange> ExcelWorksheet::rows(bool skip_null = true) {
    using namespace xlnt;
    xlnt::worksheet& worksheet = To_WorkSheet(*this);
    AUTO thisObj = worksheet.rows(skip_null);
    return To_ExcelRange(thisObj);
};
const cweeSharedPtr<ExcelRange> ExcelWorksheet::rows(bool skip_null = true) const {
    using namespace xlnt;
    xlnt::worksheet& worksheet = To_WorkSheet(*this);
    AUTO thisObj = worksheet.rows(skip_null);
    return To_ExcelRange(thisObj);
};
cweeSharedPtr<ExcelRange> ExcelWorksheet::columns(bool skip_null = true) {
    using namespace xlnt;
    xlnt::worksheet& worksheet = To_WorkSheet(*this);
    AUTO thisObj = worksheet.columns(skip_null);
    return To_ExcelRange(thisObj);
};
const cweeSharedPtr<ExcelRange> ExcelWorksheet::columns(bool skip_null = true) const {
    using namespace xlnt;
    xlnt::worksheet& worksheet = To_WorkSheet(*this);
    AUTO thisObj = worksheet.columns(skip_null);
    return To_ExcelRange(thisObj);
...
cweeList<int> ExcelWorksheet::page_break_columns() const {
    using namespace xlnt;
    xlnt::worksheet& worksheet = To_WorkSheet(*this);
    return worksheet.page_break_columns();
};
...
cweeSharedPtr<ExcelCell> ExcelWorksheet::GetCell(cweeStr const& cellName) {
    using namespace xlnt;
    xlnt::worksheet& worksheet = To_WorkSheet(*this);
    return To_ExcelCell(worksheet.cell(cellName.c_str()));
};
#pragma endregion
