...
namespace epanet2 {
        ...
        */
    {
        ...
        *index = 0;
        ...
        hyd->NodeDemand = (SCALER*)realloc(hyd->NodeDemand, size);
        qual->NodeQual = (SCALER*)realloc(qual->NodeQual, size);
        hyd->NodeHead = (SCALER*)realloc(hyd->NodeHead, size);
        hyd->DemandFlow = (SCALER*)realloc(hyd->DemandFlow, size);
        hyd->EmitterFlow = (SCALER*)realloc(hyd->EmitterFlow, size);
        ...
        */
    {
        ...
        *value = 0.0;
        ...
        case EN_DEMANDDEFICIT:
            ...
            v = (SCALER)(double)(hyd->DemandFlow[index] - (cubic_foot_per_second_t)(double)(hyd->NodeDemand[index] - (SCALER)(double)hyd->EmitterFlow[index])) * Ucf[FLOW];
            break;
        ...
        */
    {
        ...
        {
        case EN_ELEVATION:
            if (index <= nJuncs) Node[index].El = p->convertToUnit<foot_t>(value);
            else
            {
                value = p->convertToUnit<foot_t>(value) - Node[index].El;
                j = index - nJuncs;
                Tank[j].H0 += value;
                Tank[j].Hmin += value;
                Tank[j].Hmax += value;
        ...
        case EN_TANKLEVEL:
            ...
            {
                Tank[j].H0 = p->convertToUnit<foot_t>(value);
            ...
            {
                value = Node[index].El + p->convertToUnit<foot_t>(value);
        ...
        case EN_MINLEVEL:
            ...
            j = index - nJuncs;                        // tank index
            if (Tank[j].A == 0.0) return  0;           // tank is a reservoir
            hTmp = p->convertToUnit<foot_t>(value) + Node[index].El; // convert level to head
            if (hTmp >= Tank[j].Hmax ||
        ...
        */
    {
        ...
        node->El = p->convertToUnit<foot_t>(elev);
        return 0;
    };
        ...
        */
    {
        ...
        *index = 0;
        ...
        hyd->LinkFlow = (SCALER*)realloc(hyd->LinkFlow, size);
        hyd->LinkSetting = (SCALER*)realloc(hyd->LinkSetting, size);
        ...
        */
    {
        ...
        {
            if (nodeIndex > net->Njuncs) lvl = net->Node[nodeIndex].El + p->convertToUnit<foot_t>(level);
