...
namespace chaiscript {
    ...
    namespace eval {
        ...
        struct Compiled_AST_Node : AST_Node_Impl<T> {
            ...
            Boxed_Value eval_internal(const chaiscript::detail::Dispatch_State& t_ss) const override { EarlyExitCheck(); return m_func(this->children, t_ss); }
        ...
        struct Constant_AST_Node final : AST_Node_Impl<T> {
            ...
            Boxed_Value eval_internal(const chaiscript::detail::Dispatch_State&) const override { EarlyExitCheck(); return m_value; }
        ...
        struct Fun_Call_AST_Node : AST_Node_Impl<T> {
            ...
            Boxed_Value eval_internal(const chaiscript::detail::Dispatch_State& t_ss) const override { EarlyExitCheck(); return do_eval_internal<true>(t_ss); }
        };
        ...
        struct Assign_Retroactively_AST_Node final : AST_Node_Impl<T> {
            ...
            children[0] = FunCall(), children[1] = var or ref
        ...
        struct Postfix_AST_Node final : AST_Node_Impl<T> {
            ...
            Boxed_Value eval_internal(const chaiscript::detail::Dispatch_State& t_ss) const override {
                ...
                // var i = 0; i++; // i should be higher by 1 now.

                try {
                    // short circuit arithmetic operations
                    if (m_oper != Operators::Opers::invalid && bv.get_type_info().is_arithmetic()) {
                        if (bv.is_const()) {
