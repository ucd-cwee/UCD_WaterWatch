    ...
    class epanet {public:
            ...
            */
        {
            ...
            *index = 0;
            ...
            else
            {
                ...
                tank->Node = nIdx;
                if (nodeType == EN_TANK) tank->A = 1.0_sq_ft;
                else tank->A = 0_sq_ft;
                tank->Hmin = 0_ft;
                tank->Hmax = 0_ft;
                tank->H0 = 0_ft;
            ...
            */
        {
            ...
            *value = 0.0;
            ...
            case EN_BASEDEMAND:
                ...
                if (index <= nJuncs)
                {
                    if (Node[index]->D) v = (double)(Node[index]->D->Base * Ucf[FLOW]);
                }
                break;
            ...
            case EN_TANKVOLUME:
                if (index <= nJuncs) return 0;
                v = epanet_shared::tankvolume(p, index - nJuncs, (double)NodeHead[index]) * Ucf[VOLUME];
                break;
            ...
            */
        {
            ...
            case EN_BASEDEMAND:
                ...
                if (index <= nJuncs)
                {
                    if (Node[index]->D) Node[index]->D->Base = p->convertToUnit<cubic_foot_per_second_t>(value);
                }
                break;
            ...
            */
        {
            ...
            if (node->D)
            {
                (node->D)->Base = p->convertToUnit<cubic_foot_per_second_t>(dmnd);
                (node->D)->Pat = patIndex;
            }
            ...
            */
        {
            ...
            *demandIndex = 0;
            ...
            for (d = p->network->Node[nodeIndex]->D; d != nullptr; d = d->next)
            {
                n++;
                if (d->Name == NULL)
                {
            ...
            */
        {
            ...
            for (d = p->network->Node[nodeIndex]->D; d != nullptr; d = d->next) n++;
            *numDemands = n;
            return 0;
        };
            ...
            */
        {
            ...
            n = net->Npats + 1;
            net->Pattern.AssureSize(n + 1); for (auto& x : net->Pattern) if (!x) x = make_cwee_shared<Spattern>();
            ...
            */
        {
            ...
            n = net->Ncurves + 1;
            net->Curve.AssureSize(n + 1); for (auto& x : net->Curve) if (!x) x = make_cwee_shared<Scurve>();
            ...
            curve->X.ClearedResize(1);
            curve->Y.ClearedResize(1);
            {
                curve->X[0] = 1.0;
                curve->Y[0] = 1.0;
            }
            ...
            */
        {
            ...
            net->Curve[index]->X.Clear();
            net->Curve[index]->Y.Clear();
