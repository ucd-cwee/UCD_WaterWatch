...
struct DataManager
{
    static long long getCount(int element, int* count, Network* nw);

    static int getNodeIndex(const char* name, int* index, Network* nw);
    ...
    static int getLinkIndex(const char* name, int* index, Network* nw);
