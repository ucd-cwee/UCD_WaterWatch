...
namespace chaiscript {
    ...
    Type_Conversion vector_conversion(const Type_Conversions_State* state) {
        auto func = [state](const Boxed_Value& t_bv, Type_Conversions_State const& state) -> Boxed_Value {

            const chaiscript::small_vector<Boxed_Value>& from_vec = detail::Cast_Helper<const chaiscript::small_vector<Boxed_Value>&>::cast(t_bv, &state); 
