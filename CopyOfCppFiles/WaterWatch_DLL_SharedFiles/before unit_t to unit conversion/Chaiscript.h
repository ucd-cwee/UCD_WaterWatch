...
namespace chaiscript {
    ...
    inline chaiscript::unique_ptr<chaiscript::parser::ChaiScript_Parser_Base> make_parser() {
        return chaiscript::unique_ptr<chaiscript::parser::ChaiScript_Parser_Base>(dynamic_cast<chaiscript::parser::ChaiScript_Parser_Base*>(new chaiscript::parser::ChaiScript_Parser<Tracer, Optimizer>()));
    }
