...
template <typename E> INLINE constexpr typename std::underlying_type<E>::type enumClassCast(E e) noexcept { return static_cast<typename std::underlying_type<E>::type>(e); };
template <typename E> INLINE constexpr int enumClassToInt(E e) noexcept { return (int)enumClassCast(e); };
