...
namespace epanet2 {
    static  int EN_createproject(EN_Project* p)
        /*----------------------------------------------------------------
        **  Input:   none
    ...
    static  int EN_deleteproject(EN_Project p)
        /*----------------------------------------------------------------
        **  Input:   none
        **  Output:  none
        **  Returns: error code
        ...
        */
    {
        ...
        *index = 0;
        ...
        size = (net->Nnodes + 2) * sizeof(SCALER);
        ...
        */
    {
        ...
        SCALER* Ucf = p->Ucf;
        SCALER* NodeHead = hyd->NodeHead;
        SCALER* NodeQual = qual->NodeQual;
        ...
        *value = 0.0;
        ...
        case EN_NODE_INCONTROL:
            v = (SCALER)incontrols(p, NODE, index);
            break;
        ...
        */
    {
        ...
        else if (!adddemand(node, dmnd, patIndex, nullptr)) return 101;
        ...
        */
    {
        ...
        strcpy(demandName, d->Name.c_str());
        return 0;
    };
        ...
        */
    {
        ...
        Spump* Pump = net->Pump;
        SCALER* Ucf = p->Ucf;
        SCALER* LinkFlow = hyd->LinkFlow;
        SCALER* LinkSetting = hyd->LinkSetting;
        ...
        *value = 0.0;
        ...
        case EN_LINKPATTERN:
            if (Link[index].Type == PUMP)
            {
                v = (SCALER)Pump[findpump(&p->network, index)].Upat;
            }
            break;
        ...
        case EN_PUMP_HCURVE:
            if (Link[index].Type == PUMP)
            {
                v = (SCALER)Pump[findpump(&p->network, index)].Hcurve;
            }
            break;
        ...
        case EN_PUMP_ECURVE:
            if (Link[index].Type == PUMP)
            {
                v = (SCALER)Pump[findpump(&p->network, index)].Ecurve;
            }
            break;
        ...
        case EN_PUMP_ECOST:
            if (Link[index].Type == PUMP)
            {
                v = (SCALER)Pump[findpump(&p->network, index)].Ecost;
            }
            break;
        ...
        case EN_PUMP_EPAT:
            if (Link[index].Type == PUMP)
            {
                v = (SCALER)Pump[findpump(&p->network, index)].Epat;
            }
            break;
        ...
        case EN_LINK_INCONTROL:
            v = (SCALER)incontrols(p, LINK, index);
            break;
        ...
        */
    {
        ...
        if (Pattern[index].F == nullptr) return 101;
        ...
        */
    {
        ...
        curve = &net->Curve[n];
        curve->ID = id;
        curve->Comment = nullptr;
        curve->Capacity = 1;
        curve->Npts = 1;
        curve->Type = GENERIC_CURVE;
        curve->X.ClearedResize(1);
        curve->Y.ClearedResize(1);
        if (curve->X == nullptr) err = 1;
        else if (curve->Y == nullptr) err = 1;
        else
        {
            curve->X[0] = 1.0;
            curve->Y[0] = 1.0;
