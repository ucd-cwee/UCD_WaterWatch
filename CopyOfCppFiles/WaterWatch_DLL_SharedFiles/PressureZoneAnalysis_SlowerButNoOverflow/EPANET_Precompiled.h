...
#undef ReduceMemoryFor
    ...
    public:
        ...
        int   NumberOfBoundaryLinksBetweenZones(cweeSharedPtr<Szone> const& zone) {
            ...
            for (auto& BL : Boundary_Link) {
                ...
                case direction_t::FLOW_IN_DMA:
                    reply = BL.get<0>()->StartingNode->Zone->NumberOfBoundaryLinksBetweenZones<distance + 1>(zone);
                    break;
                case direction_t::FLOW_OUT_DMA:
                    reply = BL.get<0>()->EndingNode->Zone->NumberOfBoundaryLinksBetweenZones<distance + 1>(zone);
                    break;
        ...
        template<> int   NumberOfBoundaryLinksBetweenZones<10>(cweeSharedPtr<Szone> const& zone) { return -1; };
