...
public:
	cweeUnion<int, epanet::EN_Project>   createNewProject(void) {
		...
		AUTO p = epanet::epanet::EN_createproject();
		projectMap.GetExclusive()->operator[](projectNum) = p;
...
public:
	...
	void setTimeParam(int const& param, units::time::second_t const& value) { EPAnetLocal->setTimeParam(proj, param, value); };
	...
	units::time::second_t getTimeParam(int const& param) { return EPAnetLocal->getTimeParam(proj, param); };
	int	 getFlowUnits() { return EPAnetLocal->getFlowUnits(proj); };

	units::time::second_t getCurrentSimTime() { return EPAnetLocal->getCurrentSimTime(proj); };
	units::time::second_t getCurrentSimTimestep() { return EPAnetLocal->getCurrentSimTimestep(proj); };
