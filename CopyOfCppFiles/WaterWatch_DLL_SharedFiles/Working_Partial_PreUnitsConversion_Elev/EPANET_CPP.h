...
namespace epanet {
    class epanet {public:
        static EN_Project EN_createproject()
            /*----------------------------------------------------------------
            **  Input:   none
        ...
        static  int EN_clearproject(EN_Project p)
            /*----------------------------------------------------------------
            **  Input:   none
            **  Output:  none
            **  Returns: error code
        ...
        static  int EN_runproject(EN_Project p, const char* inpFile, const char* rptFile, const char* outFile, void (*pviewprog)(char*))
            /*------------------------------------------------------------------------
        ...
        static  int EN_init(EN_Project p, const char* rptFile, const char* outFile, int unitsType, int headLossType)
            /*----------------------------------------------------------------
        ...
        static  int EN_open(EN_Project p, const char* inpFile, const char* rptFile = "", const char* outFile = "")
            /*----------------------------------------------------------------
        ...
        static  int EN_gettitle(EN_Project p, char* line1, char* line2, char* line3)
            /*----------------------------------------------------------------
            **  Input:   None
        ...
        static  int EN_settitle(EN_Project p, char* line1, char* line2, char* line3)
            /*----------------------------------------------------------------
        ...
        static  int EN_getcomment(EN_Project p, int object, int index, char* comment)
            /*----------------------------------------------------------------
        ...
        static  int EN_setcomment(EN_Project p, int object, int index, char* comment)
            /*----------------------------------------------------------------
            **  Input:   object = a type of object (see EN_ObjectType)
            **           index = the object's index
        ...
        static  int EN_getcount(EN_Project p, int object, int* count)
            /*----------------------------------------------------------------
        ...
        static  int EN_saveinpfile(EN_Project p, const char* filename)
            /*----------------------------------------------------------------
        ...
        static  int EN_close(EN_Project p)
            /*----------------------------------------------------------------
                **  Input:   none
                **  Output:  none
                **  Returns: error code
        ...
        static  int EN_solveH(EN_Project p)
            /*----------------------------------------------------------------
                **  Input:   none
                **  Output:  none
                **  Returns: error code
        ...
        static  int EN_saveH(EN_Project p)
            /*----------------------------------------------------------------
                **  Input:   none
                **  Output:  none
                **  Returns: error code
        ...
        static  int EN_openH(EN_Project p)
            /*----------------------------------------------------------------
                **  Input:   none
                **  Output:  none
                **  Returns: error code
        ...
        static  int EN_initH(EN_Project p, int initFlag)
            /*----------------------------------------------------------------
        ...
        static  int EN_runH(EN_Project p, units::time::second_t* currentTime)
            /*----------------------------------------------------------------
            **  Input:   none
            ...
            */
        {
            ...
            *currentTime = 0;
            if (!p->hydraul.OpenHflag) return 103;
            errcode = epanet_shared::runhyd(p, currentTime);
            if (errcode) epanet_shared::errmsg(p, errcode);
            return errcode;
        };
        static  int EN_nextH(EN_Project p, units::time::second_t* tStep)
            /*----------------------------------------------------------------
            **  Input:   none
        ...
        static  int EN_closeH(EN_Project p)
            /*----------------------------------------------------------------
            **  Input:   none
            **  Output:  none
            **  Returns: error code
        ...
        static  int EN_savehydfile(EN_Project p, const char* filename)
            /*----------------------------------------------------------------
        ...
        static  int EN_usehydfile(EN_Project p, const char* filename)
            /*----------------------------------------------------------------
        ...
        static  int EN_solveQ(EN_Project p)
            /*----------------------------------------------------------------
            **  Input:   none
            **  Output:  none
            **  Returns: error code
        ...
        static  int EN_openQ(EN_Project p)
            /*----------------------------------------------------------------
            **  Input:   none
            **  Output:  none
            **  Returns: error code
        ...
        static  int EN_initQ(EN_Project p, int saveFlag)
            /*----------------------------------------------------------------
        ...
        static  int EN_runQ(EN_Project p, units::time::second_t* currentTime)
            /*----------------------------------------------------------------
            **  Input:   none
        ...
        static  int EN_nextQ(EN_Project p, units::time::second_t* tStep)
            /*----------------------------------------------------------------
            **  Input:   none
        ...
        static  int EN_stepQ(EN_Project p, units::time::second_t* timeLeft)
            /*----------------------------------------------------------------
            **  Input:   none
        ...
        static  int EN_closeQ(EN_Project p)
            /*----------------------------------------------------------------
            **  Input:   none
            **  Output:  none
            **  Returns: error code
        ...
        static  int EN_writeline(EN_Project p, char* line)
            /*----------------------------------------------------------------
        ...
        static  int EN_report(EN_Project p)
            /*----------------------------------------------------------------
            **  Input:   none
            **  Output:  none
            **  Returns: error code
        ...
        static  int EN_copyreport(EN_Project p, char* filename)
            /*----------------------------------------------------------------
        ...
        static  int EN_clearreport(EN_Project p)
            /*----------------------------------------------------------------
            **  Input:   none
            **  Output:  none
            **  Returns: error code
        ...
        static  int EN_resetreport(EN_Project p)
            /*----------------------------------------------------------------
            **  Input:   none
            **  Output:  none
            **  Returns: error code
        ...
        static  int EN_setreport(EN_Project p, char* format)
            /*----------------------------------------------------------------
        ...
        static  int EN_setstatusreport(EN_Project p, int level)
            /*----------------------------------------------------------------
        ...
        static  int EN_getversion(int* version)
            /*----------------------------------------------------------------
            **  Input:    none
        ...
        static  int EN_geterror(int errcode, char* errmsg, int maxLen)
            /*----------------------------------------------------------------
        ...
        static  int EN_getstatistic(EN_Project p, int type, SCALER* value)
            /*----------------------------------------------------------------
        ...
        static  int EN_getresultindex(EN_Project p, int type, int index, int* value)
            /*----------------------------------------------------------------
        ...
        static  int EN_getoption(EN_Project p, int option, SCALER* value)
            /*----------------------------------------------------------------
        ...
        static  int EN_setoption(EN_Project p, int option, SCALER value)
            /*----------------------------------------------------------------
        ...
        static  int EN_getflowunits(EN_Project p, int* units)
            /*----------------------------------------------------------------
            **  Input:   none
        ...
        static  int EN_setflowunits(EN_Project p, int units)
            /*----------------------------------------------------------------
        ...
        static  int EN_gettimeparam(EN_Project p, int param, units::time::second_t* value)
            /*----------------------------------------------------------------
        ...
        static  int EN_settimeparam(EN_Project p, int param, units::time::second_t value)
            /*----------------------------------------------------------------
            **  Input:   param = time parameter code (see EN_TimeParameter)
        ...
        static  int EN_getqualinfo(EN_Project p, int* qualType, char* chemName, char* chemUnits, int* traceNode)
            /*----------------------------------------------------------------
            **  Input:   none
        ...
        static  int EN_getqualtype(EN_Project p, int* qualType, int* traceNode)
            /*----------------------------------------------------------------
            **  Input:   none
            **  Output:  qualType = type of quality analysis to run (see EN_QualityType)
        ...
        static  int EN_setqualtype(EN_Project p, int qualType, char* chemName, char* chemUnits, char* traceNode)
            /*----------------------------------------------------------------
        ...
        static  int EN_addnode(EN_Project p, char* id, int nodeType, int* index)
            /*----------------------------------------------------------------
            ...
            */
        {
            ...
            *index = 0;
            ...
            net->Node.AssureSize(net->Nnodes + 2); for (auto& x : net->Node) { if (!x) { x = make_cwee_shared<Snode>(); } }            
            hyd->NodeDemand.AssureSize(net->Nnodes + 2);
            qual->NodeQual = (SCALER*)realloc(qual->NodeQual, (net->Nnodes + 2) * sizeof(SCALER));
            ...
            if (nodeType == EN_JUNCTION)
            {
                ...
                net->Njuncs++;
                nIdx = net->Njuncs;
                net->Node[nIdx] = make_cwee_shared<Snode>(asset_t::JUNCTION, cweeAssetValueCollection<asset_t::JUNCTION>().Values, id);
                node = net->Node[nIdx];
                node->D = NULL;
                epanet_shared::adddemand(node, 0.0, 0, NULL);
            ...
            else
            {
                // resize tanks array
                net->Ntanks++;
                net->Tank.AssureSize(net->Ntanks + 1); for (auto& x : net->Tank) if (!x) x = make_cwee_shared<Stank>(id);
        ...
        static  int EN_deletenode(EN_Project p, int index, int actionCode)
            /*----------------------------------------------------------------
        ...
        static  int EN_getnodeindex(EN_Project p, char* id, int* index)
            /*----------------------------------------------------------------
            **  Input:   id = node ID name
        ...
        static  int EN_getnodeid(EN_Project p, int index, char* id)
            /*----------------------------------------------------------------
        ...
        static  int EN_setnodeid(EN_Project p, int index, char* newid)
            /*----------------------------------------------------------------
            **  Input:   index = node index
        ...
        static  int EN_getnodetype(EN_Project p, int index, int* nodeType)
            /*----------------------------------------------------------------
            **  Input:   index = node index
            ...
            */
        {
            *nodeType = -1;
            ...
            {
                if (p->network->Tank[index - p->network->Njuncs]->A == 0.0_sq_ft)
                {
        ...
        static  int EN_getnodevalue(EN_Project p, int index, int property, SCALER* value)
            /*----------------------------------------------------------------
            **  Input:   index = node index
            ...
            */
        {
            ...
            *value = 0.0;
            ...
            case EN_PATTERN:
                ...
                if (index <= nJuncs)
                {
                    if (Node[index]->D) v = (SCALER)(Node[index]->D->Pat);
                }
            ...
            case EN_TANKLEVEL:
                ...
                v = (double)(Tank[index - nJuncs]->H0 - Node[index]->El);
                break;

            case EN_INITVOLUME:
                v = 0.0;
                if (index > nJuncs) v = (double)(Tank[index - nJuncs]->V0 * Ucf[VOLUME]);
                break;
            ...
            case EN_MIXZONEVOL:
                v = 0.0;
                if (index > nJuncs)
                    v = (double)(Tank[index - nJuncs]->V1frac * Tank[index - nJuncs]->Vmax * Ucf[VOLUME]);
                break;
            ...
            case EN_PRESSURE:
                v = (double)(((foot_t)(double)NodeHead[index] - Node[index]->El) * Ucf[PRESSURE]);
                break;
            ...
            case EN_MINVOLUME:
                v = 0.0;
                if (index > nJuncs) v = (double)(Tank[index - nJuncs]->Vmin * Ucf[VOLUME]);
                break;

            case EN_MAXVOLUME:
                v = 0.0;
                if (index > nJuncs) v = (double)(Tank[index - nJuncs]->Vmax * Ucf[VOLUME]);
                break;
            ...
            case EN_TANKVOLUME:
                if (index <= nJuncs) return 0;
                v = epanet_shared::tankvolume(p, index - nJuncs, NodeHead[index]) * Ucf[VOLUME];
                break;
        ...
        static  int EN_setnodevalue(EN_Project p, int index, int property, SCALER value)
            /*----------------------------------------------------------------
            **  Input:   index = node index
            **           property  = node property code (see EN_NodeProperty)
            ...
            */
        {
            ...
            case EN_ELEVATION:
                ...
                else
                {
                    ...
                    j = index - nJuncs;
                    Tank[j]->H0 += p->convertToUnit<foot_t>((double)value);
                    ...
                    hyd->NodeHead[index] += (double)p->convertToUnit<foot_t>((double)value);
                }
                break;
            ...
            case EN_TANKLEVEL:
                if (index <= nJuncs) return 0;
                j = index - nJuncs;
                if (Tank[j]->A == 0.0_sq_ft) /* Tank is a reservoir */
                {
                    Tank[j]->H0 = p->convertToUnit<foot_t>((double)value);
                    Tank[j]->Hmin = Tank[j]->H0;
                    Tank[j]->Hmax = Tank[j]->H0;
                    Node[index]->El = Tank[j]->H0;
                    hyd->NodeHead[index] = (double)Tank[j]->H0;
                }
                else
                {
                    ...
                    Tank[j]->H0 = (double)value;
                    Tank[j]->V0 = (double)epanet_shared::tankvolume(p, j, (double)Tank[j]->H0);
            ...
            case EN_TANKDIAM:
                ...
                if (Tank[j]->A == 0.0_sq_ft) return 0;                // tank is a reservoir
                Tank[j]->Diameter = p->convertToUnit<foot_t>(value); // diameter in feet                                         
                Tank[j]->A = PI * SQR(Tank[j]->Diameter) / 4.0;             // new tank area
                ...
                Tank[j]->V0 = (double)epanet_shared::tankvolume(p, j, (double)Tank[j]->H0);     // new init. volume
                Tank[j]->Vmax = (double)epanet_shared::tankvolume(p, j, (double)Tank[j]->Hmax); // new max. volume
                break;
            ...
            case EN_MINVOLUME:
                ...
                if (i > 0)                                 // tank has a volume curve
                {
                    ...
                    hTmp = epanet_shared::tankgrade(p, j, value);         // head at given volume
                    if ((foot_t)(double)hTmp > Tank[j]->H0 || (foot_t)(double)hTmp > Tank[j]->Hmax) return 225;   // invalid water levels
                    Tank[j]->Hmin = (foot_t)(double)hTmp;                   // new min. head
                    Tank[j]->Vmin = (cubic_foot_t)(double)value;                  // new min. volume
                }
                else                                       // tank has no volume curve
                {
                    ...
                    else Tank[j]->Vmin = (cubic_foot_t)(double)(value / Ucf[VOLUME]);
            ...
            case EN_VOLCURVE:
                ...
                Tank[j]->Vmin = (double)epanet_shared::tankvolume(p, j, (double)Tank[j]->Hmin); // new min. volume
                Tank[j]->V0 = (double)epanet_shared::tankvolume(p, j, (double)Tank[j]->H0);     // new init. volume
                Tank[j]->Vmax = (double)epanet_shared::tankvolume(p, j, (double)Tank[j]->Hmax); // new max. volume
                Tank[j]->A = p->convertToUnit<square_foot_t>((curve->Y[n] - curve->Y[0]) / (curve->X[n] - curve->X[0])); 
                Tank[j]->Diameter = units::math::sqrt(Tank[j]->A * 4.0 / PI); // nominal diameter
            ...
            case EN_MINLEVEL:
                ...
                if ((foot_t)(double)hTmp >= Tank[j]->Hmax || (foot_t)(double)hTmp > Tank[j]->H0) return 225;         // invalid water levels
                i = Tank[j]->Vcurve;                        // volume curve index
                if (i > 0)                                 // tank has a volume curve
                {
                    curve = &net->Curve[i];
                    if (value < curve->X[0]) return 225;   // new level is off curve
                    Tank[j]->Vmin = (double)epanet_shared::tankvolume(p, j, hTmp); // new min. volume
                }
            ...
            case EN_MAXLEVEL:
                ...
                if (Tank[j]->A == 0.0_sq_ft) return 0;            // tank is a reservoir
                hTmp = (double)(p->convertToUnit<foot_t>((double)value) + Node[index]->El); // convert level to head
                if ((foot_t)(double)hTmp < Tank[j]->Hmin || (foot_t)(double)hTmp < Tank[j]->H0) return 225;         // invalid water levels
                i = Tank[j]->Vcurve;                        // volume curve index
                if (i > 0)                                 // tank has a volume curve
                {
                    curve = &net->Curve[i];
                ...
                Tank[j]->Vmax = (double)epanet_shared::tankvolume(p, j, hTmp);     // new max. volume
                break;
            ...
            case EN_MIXMODEL:
                ...
                if (Tank[index - nJuncs]->A > 0.0_sq_ft)
                {
        ...
        static  int EN_setjuncdata(EN_Project p, int index, SCALER elev, SCALER dmnd, char* dmndpat)
            /*----------------------------------------------------------------
            ...
            */
        {
            ...
            else if (!epanet_shared::adddemand(node, dmnd, patIndex, NULL)) return 101;
        ...
        static  int EN_settankdata(EN_Project p, int index, SCALER elev, SCALER initlvl, SCALER minlvl, SCALER maxlvl, SCALER diam, SCALER minvol, char* volcurve)
            /*----------------------------------------------------------------
            ...
            */
        {
            ...
            Tank[j]->A = p->convertToUnit<square_foot_t>(area);
            Tank[j]->H0 = p->convertToUnit<foot_t>(elev + initlvl);
            Tank[j]->Hmin = p->convertToUnit<foot_t>(elev + minlvl);
            Tank[j]->Hmax = p->convertToUnit<foot_t>(elev + maxlvl);
            Tank[j]->Vcurve = curveIndex;
            if (curveIndex == 0)
            {
                if (minvol > 0.0) Tank[j]->Vmin = (double)(minvol / Ucf[VOLUME]);
                else Tank[j]->Vmin = Tank[j]->A * (Tank[j]->Hmin - p->convertToUnit<foot_t>(elev));
            }
            else Tank[j]->Vmin = (double)epanet_shared::tankvolume(p, j, (double)Tank[j]->Hmin);
            Tank[j]->V0 = (double)epanet_shared::tankvolume(p, j, (double)Tank[j]->H0);
            Tank[j]->Vmax = (double)epanet_shared::tankvolume(p, j, (double)Tank[j]->Hmax);
            return 0;
        };
        static  int EN_getcoord(EN_Project p, int index, SCALER* x, SCALER* y)
            /*----------------------------------------------------------------
            **  Input:   index = node index
        ...
        static  int EN_setcoord(EN_Project p, int index, SCALER x, SCALER y)
            /*----------------------------------------------------------------
            **  Input:   index = node index
            **           x = node x-coordinate
            **           y = node y-coordinate
        ...
        static  int EN_getdemandmodel(EN_Project p, int* model, SCALER* pmin, SCALER* preq, SCALER* pexp)
            /*----------------------------------------------------------------
            **  Input:   none
        ...
        static  int EN_setdemandmodel(EN_Project p, int model, SCALER pmin, SCALER preq, SCALER pexp)
            /*----------------------------------------------------------------
        ...
        static  int EN_adddemand(EN_Project p, int nodeIndex, SCALER baseDemand, char* demandPattern, char* demandName)
            /*----------------------------------------------------------------
            ...
            */
        {
            ...
            if (!epanet_shared::adddemand(node, baseDemand / p->Ucf[FLOW], patIndex, demandName)) return 101;
            return 0;
        };
        static  int EN_deletedemand(EN_Project p, int nodeIndex, int demandIndex)
            /*----------------------------------------------------------------
            **  Input:   nodeIndex = node index
        ...
        static  int EN_getdemandindex(EN_Project p, int nodeIndex, char* demandName, int* demandIndex)
            /*----------------------------------------------------------------
            **  Input:   nodeIndex = node index
        ...
        static  int EN_getnumdemands(EN_Project p, int nodeIndex, int* numDemands)
            /*----------------------------------------------------------------
            **  Input:   nodeIndex = node index
        ...
        static  int EN_getbasedemand(EN_Project p, int nodeIndex, int demandIndex, SCALER* baseDemand)
            /*----------------------------------------------------------------
            **  Input:   nodeIndex = node index
            ...
            */
        {
            ...
            *baseDemand = 0.0;
            ...
            // Locate target demand in node's demands list
            d = epanet_postcompiled::finddemand(p->network->Node[nodeIndex]->D, demandIndex);
            if (d == NULL) return 253;
        ...
        static  int EN_setbasedemand(EN_Project p, int nodeIndex, int demandIndex, SCALER baseDemand)
            /*----------------------------------------------------------------
            **  Input:   nodeIndex = node index
            **           demandIndex = demand category index
            **           baseDemand = baseline demand value
        ...
        static  int EN_getdemandname(EN_Project p, int nodeIndex, int demandIndex, char* demandName)
            /*----------------------------------------------------------------
            **  Input:   nodeIndex = node index
            **           demandIndex = demand category index
        ...
        static  int EN_setdemandname(EN_Project p, int nodeIndex, int demandIndex, char* demandName)
            /*----------------------------------------------------------------
            **  Input:   nodeIndex = node index
            **           demandIndex = demand category index
        ...
        static  int EN_getdemandpattern(EN_Project p, int nodeIndex, int demandIndex, int* patIndex)
            /*----------------------------------------------------------------
            **  Input:   nodeIndex = node index
            **           demandIndex = demand category index
        ...
        static  int EN_setdemandpattern(EN_Project p, int nodeIndex, int demandIndex, int patIndex)
            /*----------------------------------------------------------------
            **  Input:   nodeIndex = node index
            **           demandIndex = demand category index
        ...
        static  int EN_addlink(EN_Project p, char* id, int linkType, char* fromNode, char* toNode, int* index)
            /*----------------------------------------------------------------
            ...
            */
        {
            ...
            *index = 0;
            ...
            n = net->Nlinks;
            net->Link.AssureSize(n + 1); for (auto& x : net->Link) if (!x) x = make_cwee_shared<Slink>();
            ...
            else if (linkType == PUMP)
            {
                ...
                net->Npumps++;
                net->Pump.AssureSize(net->Npumps + 1); for (auto& x : net->Pump) if (!x) x = make_cwee_shared<Spump>(id);
            ...
            else
            {
                ...
                net->Nvalves++;
                net->Valve.AssureSize(net->Nvalves + 1); for (auto& x : net->Valve) if (!x) x = make_cwee_shared<Svalve>(id);
        ...
        static  int EN_deletelink(EN_Project p, int index, int actionCode)
            /*----------------------------------------------------------------
        ...
        static  int EN_getlinkindex(EN_Project p, char* id, int* index)
            /*----------------------------------------------------------------
            **  Input:   id = link ID name
        ...
        static  int EN_getlinkid(EN_Project p, int index, char* id)
            /*----------------------------------------------------------------
        ...
        static  int EN_setlinkid(EN_Project p, int index, char* newid)
            /*----------------------------------------------------------------
            **  Input:   index = link index
            **           id = link ID name
            **  Output:  none
        ...
        static  int EN_getlinktype(EN_Project p, int index, int* linkType)
            /*----------------------------------------------------------------
            **  Input:   index = link index
        ...
        static  int EN_setlinktype(EN_Project p, int* index, int linkType, int actionCode)
            /*----------------------------------------------------------------
            **  Input:   index = link index
        ...
        static  int EN_getlinknodes(EN_Project p, int index, int* node1, int* node2)
            /*----------------------------------------------------------------
            **  Input:   index = link index
        ...
        static  int EN_setlinknodes(EN_Project p, int index, int node1, int node2)
            /*----------------------------------------------------------------
            **  Input:   index = link index
        ...
        static  int EN_getlinkvalue(EN_Project p, int index, int property, SCALER* value)
            /*----------------------------------------------------------------
            **  Input:   index = link index
            ...
            */
        {
            ...
            *value = 0.0;
            ...
            case EN_ENERGY:
                epanet_shared::getenergy(p, index, &v, &a);
                break;
            ...
            case EN_PUMP_EFFIC:
                epanet_shared::getenergy(p, index, &a, &v);
                break;
            ...
            case EN_PUMP_ECOST:
                if (Link[index]->Type == PUMP)
                {
                    v = (SCALER)Pump[epanet_shared::findpump(p->network, index)]->Ecost;
                }
                break;
        ...
        static  int EN_setlinkvalue(EN_Project p, int index, int property, SCALER value)
            /*----------------------------------------------------------------
            **  Input:   index = link index
            **           property  = link property code (see EN_LinkProperty)
            ...
            */
        {
            ...
            case EN_STATUS:
                ...
                {
                    epanet_shared::setlinkstatus(p, index, s, &Link[index]->Status, &Link[index]->Kc);
                }
                else
                {
            ...
            case EN_SETTING:
                ...
                else
                {
                    ...
                    {
                        epanet_shared::setlinksetting(p, index, value, &Link[index]->Status, &Link[index]->Kc);
                    }
                    else
                    {
        ...
        static  int EN_setpipedata(EN_Project p, int index, SCALER length, SCALER diam, SCALER rough, SCALER mloss)
            /*----------------------------------------------------------------
        ...
        static  int EN_getvertexcount(EN_Project p, int index, int* count)
            /*----------------------------------------------------------------
            **  Input:   index = link index
        ...
        static  int EN_getvertex(EN_Project p, int index, int vertex, SCALER* x, SCALER* y)
            /*----------------------------------------------------------------
            **  Input:   index = link index
        ...
        static  int EN_setvertex(EN_Project p, int index, int vertex, SCALER x, SCALER y)
            /*----------------------------------------------------------------
            **  Input:   index = link index
            **           vertex = index of a link vertex point
        ...
        static  int EN_setvertices(EN_Project p, int index, SCALER* x, SCALER* y, int count)
            /*----------------------------------------------------------------
            **  Input:   index = link index
        ...
        static  int EN_getpumptype(EN_Project p, int linkIndex, int* pumpType)
            /*----------------------------------------------------------------
        ...
        static  int EN_getheadcurveindex(EN_Project p, int linkIndex, int* curveIndex)
            /*----------------------------------------------------------------
            **  Input:   linkIndex = index of a pump link
        ...
        static  int EN_setheadcurveindex(EN_Project p, int linkIndex, int curveIndex)
            /*----------------------------------------------------------------
            **  Input:   linkIndex = index of a pump link
        ...
        static  int EN_addpattern(EN_Project p, char* id)
            /*----------------------------------------------------------------
        ...
        static  int EN_deletepattern(EN_Project p, int index)
            /*----------------------------------------------------------------
        ...
        static  int EN_getpatternindex(EN_Project p, char* id, int* index)
            /*----------------------------------------------------------------
        ...
        static  int EN_getpatternid(EN_Project p, int index, char* id)
            /*----------------------------------------------------------------
        ...
        static  int EN_setpatternid(EN_Project p, int index, char* id)
            /*----------------------------------------------------------------
            **  Input:   index = time pattern index
        ...
        static  int EN_getpatternlen(EN_Project p, int index, int* len)
            /*----------------------------------------------------------------
            **  Input:   index = time pattern index
        ...
        static  int EN_getpatternvalue(EN_Project p, int index, int period, SCALER* value)
            /*----------------------------------------------------------------
            **  Input:   index = time pattern index
        ...
        static  int EN_setpatternvalue(EN_Project p, int index, int period, SCALER value)
            /*----------------------------------------------------------------
            **  Input:   index = time pattern index
            **           period = time pattern period
        ...
        static  int EN_getaveragepatternvalue(EN_Project p, int index, SCALER* value)
            /*----------------------------------------------------------------
            **  Input:   index = time pattern index
        ...
        static  int EN_setpattern(EN_Project p, int index, SCALER* values, int len)
            /*----------------------------------------------------------------
            **  Input:   index = time pattern index
        ...
        static  int EN_addcurve(EN_Project p, char* id)
            /*----------------------------------------------------------------
            ...
            */
        {
            ...
            curve->X = (SCALER*)calloc(1, sizeof(SCALER));
            curve->Y = (SCALER*)calloc(1, sizeof(SCALER));
        ...
        static  int EN_deletecurve(EN_Project p, int index)
            /*----------------------------------------------------------------
        ...
        static  int EN_getcurveindex(EN_Project p, char* id, int* index)
            /*----------------------------------------------------------------
        ...
        static  int EN_getcurveid(EN_Project p, int index, char* id)
            /*----------------------------------------------------------------
        ...
        static  int EN_setcurveid(EN_Project p, int index, char* id)
            /*----------------------------------------------------------------
            **  Input:   index = data curve index
        ...
        static  int EN_getcurvelen(EN_Project p, int index, int* len)
            /*----------------------------------------------------------------
            **  Input:   index = data curve index
        ...
        static  int EN_getcurvetype(EN_Project p, int index, int* type)
            /*----------------------------------------------------------------
            **  Input:   index = data curve index
        ...
        static  int EN_setcurvetype(EN_Project p, int index, int type)
            /*----------------------------------------------------------------
            **  Input:   index = data curve index
        ...
        static  int EN_getcurvevalue(EN_Project p, int curveIndex, int pointIndex, SCALER* x, SCALER* y)
            /*----------------------------------------------------------------
        ...
        static  int EN_setcurvevalue(EN_Project p, int curveIndex, int pointIndex, SCALER x, SCALER y)
            /*----------------------------------------------------------------
            **  Input:   curveIndex = data curve index
            **           pointIndex = index of a data point on the curve
        ...
        static  int EN_getcurve(EN_Project p, int index, char* id, int* nPoints, SCALER* xValues, SCALER* yValues)
            /*----------------------------------------------------------------
            **  Input:   index = data curve index
        ...
        static  int EN_setcurve(EN_Project p, int index, SCALER* xValues, SCALER* yValues, int nPoints)
            /*----------------------------------------------------------------
            **  Input:   index = data curve index
        ...
        static  int EN_addcontrol(EN_Project p, int type, int linkIndex, SCALER setting, int nodeIndex, SCALER level, int* index)
            /*----------------------------------------------------------------
        ...
        static  int EN_deletecontrol(EN_Project p, int index)
            /*----------------------------------------------------------------
        ...
        static  int EN_getcontrol(EN_Project p, int index, int* type, int* linkIndex, SCALER* setting, int* nodeIndex, SCALER* level)
            /*----------------------------------------------------------------
            **  Input:   index  = index of the control
        ...
        static  int EN_setcontrol(EN_Project p, int index, int type, int linkIndex, SCALER setting, int nodeIndex, SCALER level)
            /*----------------------------------------------------------------
            **  Input:   index  = index of the control
        ...
        static  int EN_addrule(EN_Project p, char* rule)
            /*----------------------------------------------------------------
            ...
            */
        {
            ...
            // Resize rules array
            net->Rule.AssureSize(net->Nrules + 2);
            rules->Errcode = 0;
        ...
        static  int EN_deleterule(EN_Project p, int index)
            /*----------------------------------------------------------------
        ...
        static  int EN_getrule(EN_Project p, int index, int* nPremises, int* nThenActions, int* nElseActions, SCALER* priority)
            /*----------------------------------------------------------------
            **  Input:   index  = rule index
        ...
        static  int EN_getruleID(EN_Project p, int index, char* id)
            /*----------------------------------------------------------------
            **  Input:   index = rule index
        ...
        static  int EN_getpremise(EN_Project p, int ruleIndex, int premiseIndex, int* logop, int* object, int* objIndex, int* variable, int* relop, int* status, SCALER* value)
            /*----------------------------------------------------------------
        ...
        static  int EN_setpremise(EN_Project p, int ruleIndex, int premiseIndex, int logop, int object, int objIndex, int variable, int relop, int status, SCALER value)
            /*----------------------------------------------------------------
            **  Input:   ruleIndex = rule index
            **           premiseIndex = premise index
        ...
        static  int EN_setpremiseindex(EN_Project p, int ruleIndex, int premiseIndex, int objIndex)
            /*----------------------------------------------------------------
            **  Input:   ruleIndex = rule index
            **           premiseIndex = premise index
            **           objIndex = object's index in Node or Link array
        ...
        static  int EN_setpremisestatus(EN_Project p, int ruleIndex, int premiseIndex, int status)
            /*----------------------------------------------------------------
            **  Input:   ruleIndex = rule index
            **           premiseIndex = premise index
        ...
        static  int EN_setpremisevalue(EN_Project p, int ruleIndex, int premiseIndex, SCALER value)
            /*----------------------------------------------------------------
            **  Input:   ruleIndex = rule index
            **           premiseIndex = premise index
        ...
        static  int EN_getthenaction(EN_Project p, int ruleIndex, int actionIndex, int* linkIndex, int* status, SCALER* setting)
            /*----------------------------------------------------------------
            **  Input:   ruleIndex = rule index
        ...
        static  int EN_setthenaction(EN_Project p, int ruleIndex, int actionIndex, int linkIndex, int status, SCALER setting)
            /*----------------------------------------------------------------
            **  Input:   ruleIndex = rule index
            **           actionIndex = index of a rule's THEN actions
        ...
        static  int EN_getelseaction(EN_Project p, int ruleIndex, int actionIndex, int* linkIndex, int* status, SCALER* setting)
            /*----------------------------------------------------------------
            **  Input:   ruleIndex = rule index
        ...
        static  int EN_setelseaction(EN_Project p, int ruleIndex, int actionIndex, int linkIndex, int status, SCALER setting)
            /*----------------------------------------------------------------
            **  Input:   ruleIndex = rule index
            **           actionIndex = index of a rule's ELSE actions
            **           linkIndex = index of link appearing in the action
        ...
        static  int EN_setrulepriority(EN_Project p, int index, SCALER priority)
            /*-----------------------------------------------------------------------------
            **  Input:   index  = rule index
