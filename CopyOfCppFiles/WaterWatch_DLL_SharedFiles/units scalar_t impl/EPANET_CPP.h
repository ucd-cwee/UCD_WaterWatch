    ...
    class epanet {public:
            ...
            */
        {
            ...
            *index = 0;
            ...
            hyd->NodeDemand.AssureSize(size);
            qual->NodeQual = (SCALER*)realloc(qual->NodeQual, size);
            hyd->NodeHead.AssureSize(size);
            hyd->DemandFlow.AssureSize(size);
            hyd->EmitterFlow.AssureSize(size);
            ...
            */
        {
            ...
            *index = 0;
            ...
            hyd->LinkFlow.AssureSize(size);
            hyd->LinkSetting.AssureSize(size);
            size = (n + 1) * sizeof(StatusType); // hyd->LinkStatus = (StatusType*)realloc(hyd->LinkStatus, size);
            ...
            */
        {
            ...
            pat->Comment = NULL;
            pat->Length = 1;
            pat->F = (SCALER*)calloc(1, sizeof(SCALER));
            if (pat->F == NULL) err = 1;
            else pat->F[0] = 1.0;
            ...
            */
        {
            ...
            Pattern[index].F = (SCALER*)realloc(Pattern[index].F, len * sizeof(SCALER));
