...
#pragma region Shared Functions
        ...
        static int		adddemand(Snode* node, SCALER dbase, int dpat, char* dname)
            /*----------------------------------------------------------------
            ...
            */
        {
            ...
            if (link->Vertices == NULL)
            {
                ...
                vertices->X = (SCALER*)calloc(vertices->Capacity, sizeof(SCALER));
                vertices->Y = (SCALER*)calloc(vertices->Capacity, sizeof(SCALER));
            ...
            {
                vertices->Capacity += CHUNKSIZE;
                vertices->X = (SCALER*)realloc(vertices->X, vertices->Capacity * sizeof(SCALER));
                vertices->Y = (SCALER*)realloc(vertices->Y, vertices->Capacity * sizeof(SCALER));
            }
