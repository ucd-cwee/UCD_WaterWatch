    ...
    class epanet_postcompiled { public:
            ...
            */
        {
            ...
            if (!errcode)
            {
                ...
                pr->hydraul.NodeDemand.AssureSize(n);
                pr->hydraul.NodeHead.AssureSize(n);
                pr->quality.NodeQual = (SCALER*)calloc(n, sizeof(SCALER));
                pr->hydraul.DemandFlow.AssureSize(n);
                pr->hydraul.EmitterFlow.AssureSize(n);
            ...
            if (!errcode)
            {
                ...
                pr->hydraul.LinkFlow.AssureSize(n);
                pr->hydraul.LinkSetting.AssureSize(n);
                pr->hydraul.LinkStatus.AssureSize(n + 1); 
            ...
            */
        {
            ...
            pattern->Length = 1;
            pattern[0].F = (SCALER*)calloc(1, sizeof(SCALER));
            pattern[0].F[0] = 1.0;
            ...
            */
        {
            ...
            n1 = pattern->Length;
            pattern->Length += n;
            pattern->F = (SCALER*)realloc(pattern->F, pattern->Length * sizeof(SCALER));
            ...
            */
        {
            ...
            else if (qual->Qualflag == TRACE_QUAL) sprintf(s, FMT31, net->Node[qual->TraceNode].ID);
