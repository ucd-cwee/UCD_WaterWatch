...
#pragma region Constexpr
    ...
    static constexpr SCALER PI = cweeMath::PI; // 3.141592654;
    static constexpr SCALER A1 = 1000.0 * PI; //  3.14159265358979323850e+03;   // 1000*PI
    static constexpr SCALER A2 = 500.0 * PI; // 1.57079632679489661930e+03;   // 500*PI
    static constexpr SCALER A3 = 16.0 * PI; // 5.02654824574366918160e+01;   // 16*PI
    static constexpr SCALER A4 = 2.0 * PI; // 6.28318530717958647700e+00;   // 2*PI
    ...
    static constexpr SCALER AC = AA * AB; // -5.14214965799093883760e-03;  // AA*AB
...
#undef AddValueType
    ...
    */
    ...
    class Hydraul {
    public:
        SimResults results;       // Results from all timesteps for the real date-times.
    ...
    public:
        ...
        template<typename desiredUnit> desiredUnit convertToUnit(double v, bool pipe_diameter = false) {
