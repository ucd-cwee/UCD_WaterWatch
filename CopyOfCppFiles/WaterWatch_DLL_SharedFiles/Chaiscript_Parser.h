    ...
    namespace parser {
        ...
        class ChaiScript_Parser final : public ChaiScript_Parser_Base {
            ...
            struct Operator_Matches {
                ...
                std::array<utility::Static_String, 2> m_4{ {SS("^"), SS("..")} };
            ...
            constexpr static std::array<Operator_Precedence, 12> create_operators() noexcept {
                std::array<Operator_Precedence, 12> operators = { {Operator_Precedence::Ternary_Cond,
                                                                  ...
                                                                  Operator_Precedence::Bitwise_Xor, // RG
...
#pragma warning(pop)
            ...
            //    AUTO engine_p = get_engine();
            //    if (engine_p) {
            //        ChaiScript_Parser<Tracer, Optimizer> parser(*engine_p, m_tracer, m_optimizer);
            //        return parser.parse_internal(t_input, t_fname);
            //    }
            //    else {
            //        throw("Could not instantiate the ");
            //    }
            //}
            ...
            AST_NodePtr parse_internal(const std::string& t_input, std::string t_fname) {
                ...
                //chaiscript::unique_ptr<chaiscript::AST_Node> retval = chaiscript::dynamic_unique_ptr_cast<AST_Node>(elem);
                ...
                // chaiscript::unique_ptr<AST_Node> retval = chaiscript::make_unique<AST_Node>(std::move(m_match_stack.front()));

                // chaiscript::unique_ptr<AST_Node> retval = chaiscript::unique_ptr<AST_Node>(std::move(m_match_stack.front())); // std::shared_ptr solution
