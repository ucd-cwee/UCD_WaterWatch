...
namespace dlib
{
    ...
    public:
       ...
       //         matrix<double> w3;
		...
		matrix<double> get_w1()
		{ return w1; }
		
		void set_w1(matrix<double> input_weight)
		 { w1 = input_weight; return;}	
			
		matrix<double> get_w2()
		{ return w2; }
		
		void set_w2(matrix<double> input_weight)
		{ w2 = input_weight; return;}	
		
		matrix<double> get_w3()
		{ return w3; }
		
		void set_w3(matrix<double> input_weight)
		{ w3 = input_weight; return;}	
   ...
   // private:
        ...
        mutable matrix<double> e1, e2, e3; // temporary storage
