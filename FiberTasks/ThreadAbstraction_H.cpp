...
namespace fibers {
	...
	namespace {
		__forceinline float CalculateCPULoad(unsigned long long idleTicks, unsigned long long totalTicks)
		{
		...
		__forceinline unsigned long long FileTimeToInt64(const FILETIME& ft)
		{
