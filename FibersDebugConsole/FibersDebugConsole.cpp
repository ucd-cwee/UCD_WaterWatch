...
namespace GoodLang {
				...
				public:
					...
					static bool Evaluate(PreprocessorState& state, PreprocessorDirectives const& NodeType, std::string_view Text) {
						...
						case PreprocessorDirectives::ElseIf: {
							...
							auto parsed_result = Compiler::Interpreter::parser::Parser2().Parse(ToEvaluate);
	...
	namespace Impl {
		...
		__forceinline void GetChildren(Tag< GoodLang::Engine::Compiler::Interpreter::parser::Parser2::ParseNode >, GoodLang::Engine::Compiler::Interpreter::parser::Parser2::ParseNode const& r, std::vector< NodeCache >& out) {
...
int main() {
	...
	if (1) {
		if (1) {
			...
			auto Interpretted = GoodLang::Engine::Compiler::Preprocessor().Parse(R"(
				print(ONE_HUNDRED);
	...
	if (1) {
		...
		if (1) {
			...
			auto parse{ GoodLang::Engine::Compiler::Interpreter::parser::Parser2() };
