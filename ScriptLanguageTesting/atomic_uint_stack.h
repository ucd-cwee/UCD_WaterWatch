...
namespace GL {
    ...
    private:
        ...
        public:
            ...
            static unsigned int Finalize(unsigned int p) noexcept {
                ...
                out.m_bits.m_nABA = 0;
                return (unsigned int)(uint64_t)out.m_bits.m_pNode;
            };
            bool is_null() const noexcept {
                return (uint64_t)m_bits.m_pNode == INVALID;
            };
            unsigned int Node() noexcept { return (unsigned int)(uint64_t)m_bits.m_pNode; }
    ...
    public:
            ...
            )
        {
            ...
            const_cast<TaggedIndex&>(free_head._default).m_bits.m_pNode = INVALID;
            const_cast<TaggedIndex&>(head._default).m_bits.m_pNode = INVALID;
