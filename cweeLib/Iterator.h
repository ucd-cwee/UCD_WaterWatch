...
#define SETUP_ITERATORS(ParentClass, RefIterType, StateType)  \
  SETUP_MUTABLE_ITERATOR(ParentClass, RefIterType, StateType) \
  SETUP_CONST_ITERATOR(ParentClass, RefIterType, StateType)

// Use this define to declare only `iterator`
#define SETUP_MUTABLE_ITERATOR(ParentClass, RefIterType, StateType) \
  typedef iterator_tpl::iterator<ParentClass, RefIterType, StateType> iterator;  \
  iterator begin() { return iterator::begin(this); } \
  iterator end()   { return iterator::end(this);   }

// Use this define to declare only `const_iterator`
#define SETUP_CONST_ITERATOR(ParentClass, RefIterType, StateType)                                  \
  typedef iterator_tpl::const_iterator<ParentClass, RefIterType, StateType> const_iterator;        \
  const_iterator begin() const { return const_iterator::begin(this); } \
  const_iterator end()   const { return const_iterator::end(this);   }

// S should be the state struct used to forward iteration:
#define SETUP_REVERSE_ITERATORS(ParentClass, RefIterType, StateType)                            \
  struct StateType##_reversed : public StateType {                                  \
    inline void next (const ParentClass* ref) { StateType::prev(ref); }               \
    inline void prev (const ParentClass* ref) { StateType::next(ref); }               \
    inline void begin(const ParentClass* ref) { StateType::end(ref); StateType::prev(ref);}   \
    inline void end  (const ParentClass* ref) { StateType::begin(ref); StateType::prev(ref);} \
  };                                                                \
  SETUP_MUTABLE_RITERATOR(ParentClass, RefIterType, StateType)                                  \
  SETUP_CONST_RITERATOR(ParentClass, RefIterType, StateType)

#define SETUP_MUTABLE_RITERATOR(ParentClass, RefIterType, StateType) \
  typedef iterator_tpl::iterator<ParentClass, RefIterType, StateType##_reversed > reverse_iterator; \
...
#define SETUP_CONST_RITERATOR(C, T, S)                                              \
  typedef iterator_tpl::const_iterator<ParentClass, RefIterType, StateType##_reversed > const_reverse_iterator; \
...
#define SETUP_STL_ITERATOR(ParentClass, IterType, StateType) typedef std::ptrdiff_t difference_type;											\
	...
	reverse_iterator rbegin() { AUTO iter = end(); iter--; iter.state.get(this); return reverse_iterator(iter); };								\
	reverse_iterator rend() { AUTO iter = begin(); iter.state.get(this); return reverse_iterator(iter); };										\
	typedef std::reverse_iterator<const_iterator> const_reverse_iterator;																		\
	const_reverse_iterator crbegin() const { AUTO iter = cend(); iter--; iter.state.get(this); return const_reverse_iterator(iter); };			\
	const_reverse_iterator crend() const { AUTO iter = cbegin(); iter.state.get(this); return const_reverse_iterator(iter); };					\
