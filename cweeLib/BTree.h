...
private:
	...
	cweeBlockAlloc<cweeBTreeNode<objType, keyType>, 128>	nodeAllocator;
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE cweeBTree<objType, keyType, maxChildrenPerNode>::cweeBTree() {
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE void cweeBTree<objType, keyType, maxChildrenPerNode>::Init() {
	root = AllocNode();
}

template< class objType, class keyType, int maxChildrenPerNode >
INLINE void cweeBTree<objType, keyType, maxChildrenPerNode>::Shutdown() {
	nodeAllocator.Shutdown();
	root = NULL;
}

template< class objType, class keyType, int maxChildrenPerNode >
INLINE cweeBTreeNode<objType, keyType>* cweeBTree<objType, keyType, maxChildrenPerNode>::Add(objType* object, keyType key) {
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE void cweeBTree<objType, keyType, maxChildrenPerNode>::Remove(cweeBTreeNode<objType, keyType>* node) {
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE cweeBTreeNode<objType, keyType>* cweeBTree<objType, keyType, maxChildrenPerNode>::NodeFind(keyType key) const {
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE cweeBTreeNode<objType, keyType>* cweeBTree<objType, keyType, maxChildrenPerNode>::NodeFindSmallestLargerEqual(keyType key) const {
	cweeBTreeNode<objType, keyType>* node;
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE cweeBTreeNode<objType, keyType>* cweeBTree<objType, keyType, maxChildrenPerNode>::NodeFindLargestSmallerEqual(keyType key) const {
	cweeBTreeNode<objType, keyType>* node;
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE objType* cweeBTree<objType, keyType, maxChildrenPerNode>::Find(keyType key) const {
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE objType* cweeBTree<objType, keyType, maxChildrenPerNode>::FindSmallestLargerEqual(keyType key) const {
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE objType* cweeBTree<objType, keyType, maxChildrenPerNode>::FindLargestSmallerEqual(keyType key) const {
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE cweeBTreeNode<objType, keyType>* cweeBTree<objType, keyType, maxChildrenPerNode>::GetRoot() const {
	return root;
}

template< class objType, class keyType, int maxChildrenPerNode >
INLINE int cweeBTree<objType, keyType, maxChildrenPerNode>::GetNodeCount() const {
	return nodeAllocator.GetAllocCount();
}

template< class objType, class keyType, int maxChildrenPerNode >
INLINE cweeBTreeNode<objType, keyType>* cweeBTree<objType, keyType, maxChildrenPerNode>::GetNext(cweeBTreeNode<objType, keyType>* node) const {
	if (node->firstChild) {
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE cweeBTreeNode<objType, keyType>* cweeBTree<objType, keyType, maxChildrenPerNode>::GetNextLeaf(cweeBTreeNode<objType, keyType>* node) const {
	if (node->firstChild) {
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE cweeBTreeNode<objType, keyType>* cweeBTree<objType, keyType, maxChildrenPerNode>::AllocNode() {
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE void cweeBTree<objType, keyType, maxChildrenPerNode>::FreeNode(cweeBTreeNode<objType, keyType>* node) {
	nodeAllocator.Free(node);
}

template< class objType, class keyType, int maxChildrenPerNode >
INLINE void cweeBTree<objType, keyType, maxChildrenPerNode>::SplitNode(cweeBTreeNode<objType, keyType>* node) {
	int i;
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE cweeBTreeNode<objType, keyType>* cweeBTree<objType, keyType, maxChildrenPerNode>::MergeNodes(cweeBTreeNode<objType, keyType>* node1, cweeBTreeNode<objType, keyType>* node2) {
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE void cweeBTree<objType, keyType, maxChildrenPerNode>::CheckTree_r(cweeBTreeNode<objType, keyType>* node, int& numNodes) const {
	int numChildren;
	cweeBTreeNode<objType, keyType>* child;
...
template< class objType, class keyType, int maxChildrenPerNode >
INLINE void cweeBTree<objType, keyType, maxChildrenPerNode>::CheckTree() const {
	int numNodes = 0;
