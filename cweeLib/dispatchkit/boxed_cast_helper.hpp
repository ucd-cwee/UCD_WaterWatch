...
namespace chaiscript {
  ...
  namespace detail {
    ...
    struct Cast_Helper_Inner<chaiscript::unique_ptr<Result> &&> {
      static chaiscript::unique_ptr<Result> &&cast(const Boxed_Value &ob, const Type_Conversions_State *) {
    ...
    struct Cast_Helper_Inner<chaiscript::shared_ptr<Result>> {
      static auto cast(const Boxed_Value &ob, const Type_Conversions_State *) { return ob.get().cast<chaiscript::shared_ptr<Result>>(); }
    };
  ...
  public:
      ...
      static decltype(auto) cast(const Boxed_Value& bv, const Type_Conversions_State* t_conversions) {
          return detail::Cast_Helper::cast<Type>(bv, t_conversions);
          // return GetChai().boxed_cast<Type>(bv);
      };

      //template<typename Type>
      //static decltype(auto) cast(const Boxed_Value& bv) { // , const Type_Conversions_State* t_conversions
      //    return detail::Cast_Helper::cast<Type>(bv, nullptr);
      //};
