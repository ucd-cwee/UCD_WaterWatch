...
namespace chaiscript {
  ...
  inline chaiscript::unique_ptr<chaiscript::parser::ChaiScript_Parser_Base> make_parser() {
    chaiscript::unique_ptr<chaiscript::parser::ChaiScript_Parser_Base> out(dynamic_cast<chaiscript::parser::ChaiScript_Parser_Base*>(
        new chaiscript::parser::ChaiScript_Parser<Tracer, Optimizer>()
    ));
    return out;
  }
