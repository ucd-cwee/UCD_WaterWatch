...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_gcd(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "gcd", 2, 2, swig_obj)) SWIG_fail;
...
static PyMethodDef SwigMethods[] = {
	 { "gcd", _wrap_gcd, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
# endif
  ...
  SWIG_addvarlink(globals, "Foo", Swig_var_Foo_get, Swig_var_Foo_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
